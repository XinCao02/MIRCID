...
class ResNetMLP(nn.Module):
    def __init__(self, input_size, hidden_size, output_size, dropout, num_layers=3):
        ...
        # self.layer8 = ResidualBlock(hidden_size, dropout)
        # self.layer9 = ResidualBlock(hidden_size, dropout)
        # self.layer10 = ResidualBlock(hidden_size, dropout)
        # self.layer11 = ResidualBlock(hidden_size, dropout)
        # self.layer12 = ResidualBlock(hidden_size, dropout)
        # self.layer13 = ResidualBlock(hidden_size, dropout)
        # self.layer14 = ResidualBlock(hidden_size, dropout)
        # self.layer15 = ResidualBlock(hidden_size, dropout)
        # self.layer16 = ResidualBlock(hidden_size, dropout)
        # self.layer17 = ResidualBlock(hidden_size, dropout)
        # self.layer18 = ResidualBlock(hidden_size, dropout)
        # self.layer19 = ResidualBlock(hidden_size, dropout)
        # self.layer20 = ResidualBlock(hidden_size, dropout)
        # self.layer21 = ResidualBlock(hidden_size, dropout)
        # self.layer22 = ResidualBlock(hidden_size, dropout)
        # self.layer23 = ResidualBlock(hidden_size, dropout)
        # self.layer24 = ResidualBlock(hidden_size, dropout)
        # self.layer25 = ResidualBlock(hidden_size, dropout)
        # self.layer26 = ResidualBlock(hidden_size, dropout)
        # self.layer27 = ResidualBlock(hidden_size, dropout)
        # self.layer28 = ResidualBlock(hidden_size, dropout)
        # self.layer29 = ResidualBlock(hidden_size, dropout)
        # self.layer30 = ResidualBlock(hidden_size, dropout)
        # self.layer31 = ResidualBlock(hidden_size, dropout)
        # self.layer32 = ResidualBlock(hidden_size, dropout)
        # self.layer33 = ResidualBlock(hidden_size, dropout)
        # self.layer34 = ResidualBlock(hidden_size, dropout)
        # self.layer35 = ResidualBlock(hidden_size, dropout)
        # self.layer36 = ResidualBlock(hidden_size, dropout)
        # self.layer37 = ResidualBlock(hidden_size, dropout)
        # self.layer38 = ResidualBlock(hidden_size, dropout)
        # self.layer39 = ResidualBlock(hidden_size, dropout)
        # self.layer40 = ResidualBlock(hidden_size, dropout)
        # self.layer41 = ResidualBlock(hidden_size, dropout)
        # self.layer42 = ResidualBlock(hidden_size, dropout)
        # self.layer43 = ResidualBlock(hidden_size, dropout)
        # self.layer44 = ResidualBlock(hidden_size, dropout)
        # self.layer45 = ResidualBlock(hidden_size, dropout)
        # self.layer46 = ResidualBlock(hidden_size, dropout)
        # self.layer47 = ResidualBlock(hidden_size, dropout)
        # self.layer48 = ResidualBlock(hidden_size, dropout)
        # self.layer49 = ResidualBlock(hidden_size, dropout)
        # self.layer50 = ResidualBlock(hidden_size, dropout)
    ...
    def forward(self, x):
        ...
        # out = self.layer49(out)
        # out = self.layer50(out)
