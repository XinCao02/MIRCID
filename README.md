...
This repositry is the code release for the paper "[**MIRCID**: Inferred **miR**NAs Drive **C**ross-Task **I**mprovements in **D**rug Mechanistic Modeling](https://arxiv.org/abs/2609.21280)". It contains the core HubmiRNet, transcription-factor activity (TFA), pathway-classification, feature-analysis, rescue-analysis and drug mechanism-of-action (MoA) code. All distributable data and model artifacts live in the sibling `MIRCID_dataset/` archive.
